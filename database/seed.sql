...
-- 9.1 Periods — Standard 8-period school day for the demo school
--       08:00–08:45 | 08:45–09:30 | 09:30–09:50 (Break) | 09:50–10:35
--       10:35–11:20 | 11:20–11:40 (Lunch) | 11:40–12:25 | 12:25–13:10

INSERT INTO periods (id, school_id, name, period_number, start_time, end_time, is_break)
VALUES
(
...
-- 9.2 Timetable entries — Tina Teacher's schedule for Grade 10A (Term 1)
--       Monday:    Period 1 Mathematics, Period 2 Mathematics
--       Tuesday:   Period 3 Mathematics
--       Wednesday: Period 1 Mathematics
--       Thursday:  Period 2 Mathematics
--       Friday:    Period 4 Mathematics
--       Saturday:  (no class)

INSERT INTO timetable_entries (id, school_id, academic_term_id, class_id, subject_id, teacher_id, period_id, day_of_week, room_number, is_active)
VALUES
-- Monday: Period 1 Mathematics, Period 2 Mathematics
(
